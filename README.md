...
1. Download **`WSR-Generator.exe`** (from the latest
   [Windows build](../../actions/workflows/build-windows.yml) — open the newest
   run and grab the `WSR-Generator-windows` artifact).
